    ...
    <div className={className}>
      <div className="grid md:grid-cols-12 grid-cols-1 items-center">
        <div className="md:col-span-6">
          <h4 className="text-slate-900 text-sm font-bold uppercase mb-2">
            Blogs
          </h4>
        ...
        <div className="md:col-span-6">
          <p className="text-slate-400 max-w-xl">
            Start working with companyName that can provide everything you need to
              ...
              <div className="content p-6">
                ...
                <div className="mt-4">
                  <Link
                    ...
                    aria-label={`Read more about ${data.title}`}
                  >
                    Read More <TiLocationArrow className="ms-1 text-[20px]" />
                  </Link>
                </div>
              </div>
            </div>
